...
export default async function PrivateBetaPage(): Promise<JSX.Element> {
  ...
  if (subscriptionResult.ok && subscriptionResult.subscription.plan === "pro") {
    redirect("/dashboard");
  }
      ...
      >
        <div className="rounded-md border border-border bg-surface p-8 shadow-sm sm:p-10">
          ...
          <p className="mt-4 text-base leading-7 text-text-secondary">
            JobPilot searches live job boards and researches companies for you,
            and each of those runs costs real money. While paid plans are being
            finished, access is granted by hand to a small number of accounts.
          </p>
          <p className="mt-3 text-base leading-7 text-text-secondary">
            If you are here for a demo, ask for access and mention the email
            below. Nothing else is needed from you, and you can close this page.
          </p>
